...
int main(int argc, char **argv)
{
	...
	node->declare_parameter("port", node_lidar.lidar_general_info.port);
  	node->get_parameter("port", node_lidar.lidar_general_info.port);
	
	node->declare_parameter("baudrate", node_lidar.lidar_general_info.m_SerialBaudrate);
  	node->get_parameter("baudrate", node_lidar.lidar_general_info.m_SerialBaudrate);

	node->declare_parameter("frame_id", node_lidar.lidar_general_info.frame_id);
  	node->get_parameter("frame_id", node_lidar.lidar_general_info.frame_id);
	
	node->declare_parameter("version", node_lidar.lidar_general_info.version);
